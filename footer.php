                ...
                <div class="footer-wrapper">
                    <div class="row site-info">
                        <div class="col-md-4 site-about">
                            <h5 class="title-color">About Ignite Preservation</h5>
                        ...
                        <div class="col-md-6 col-md-offset-2 site-contact">
                            <h5 class="title-color">Contact Info</h5>
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@ignitepreservation.com">info@ignitepreservation.com</a></li>
                                <li><i class="fa fa-globe" aria-hidden="true"></i> <a href="http://www.ignitepreservation.com">www.ignitepreservation.com</a></li>
                            </ul>
                        </div>
                    </div>
